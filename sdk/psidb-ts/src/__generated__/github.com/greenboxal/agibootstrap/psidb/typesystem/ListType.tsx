...
export const ListType = makeInterface({
    name: "github.com/greenboxal/agibootstrap/psidb/typesystem/ListType",
    methods: {
        AssignableTo: PrimitiveTypes.Func(Type)(bool),
        ConvertFromAny: PrimitiveTypes.Func(Value)(Value, error),
        Elem: PrimitiveTypes.Func()(Type),
        ...
        List: PrimitiveTypes.Func()(_F["ListType"]),
