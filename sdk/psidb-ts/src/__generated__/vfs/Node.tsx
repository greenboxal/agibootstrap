...
import { FileSystem } from "@psidb/psidb-sdk/types/vfs/FileSystem";
...
export const Node = makeInterface({
    ...
    methods: {
        ...
        GetFileSystem: PrimitiveTypes.Func()(FileSystem),
        GetName: PrimitiveTypes.Func()(PrimitiveTypes.String),
        GetPath: PrimitiveTypes.Func()(PrimitiveTypes.String),
        ...
        Unwatch: PrimitiveTypes.Func()(error),
        Update: PrimitiveTypes.Func(Context)(error),
        UpsertEdge: PrimitiveTypes.Func(Edge)(),
        VfsParent: PrimitiveTypes.Func()(_F["Node"]),
        Watch: PrimitiveTypes.Func()(error),
    },
});
_F["Node"] = Node;
