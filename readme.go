...
// This version of ChatGPT read each `.go` file, searched for marker comments, used `gpt-3.5-turbo` (4k) to complete them, and then wrote the result back to the file.
//
