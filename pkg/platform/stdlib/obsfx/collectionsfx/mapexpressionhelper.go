...
type mapExpressionHelper[K comparable, V any] interface {
	...
	AddListener(listener obsfx2.InvalidationListener) mapExpressionHelper[K, V]
	RemoveListener(listener obsfx2.InvalidationListener) mapExpressionHelper[K, V]
...
type genericInvalidationMapExpressionHelper[K comparable, V any] struct {
	...
	mapListeners          obsfx2.HasListenersBase[MapListener[K, V]]
}

func newGenericInvalidationMapExpressionHelper[K comparable, V any](invalidationListeners []obsfx2.InvalidationListener, listListeners []MapListener[K, V]) *genericInvalidationMapExpressionHelper[K, V] {
...
func (g *genericInvalidationMapExpressionHelper[K, V]) AddListener(listener obsfx2.InvalidationListener) mapExpressionHelper[K, V] {
	g.invalidationListeners.AddListener(listener)

	return g
}

func (g *genericInvalidationMapExpressionHelper[K, V]) RemoveListener(listener obsfx2.InvalidationListener) mapExpressionHelper[K, V] {
...
func (s *singleInvalidationMapExpressionHelper[K, V]) AddMapListener(listener MapListener[K, V]) mapExpressionHelper[K, V] {
	return newGenericInvalidationMapExpressionHelper[K, V]([]obsfx2.InvalidationListener{s.listener}, []MapListener[K, V]{listener})
}
...
func (s *singleInvalidationMapExpressionHelper[K, V]) AddListener(listener obsfx2.InvalidationListener) mapExpressionHelper[K, V] {
	if s.listener == listener {
		return s
	}

	return newGenericInvalidationMapExpressionHelper[K, V]([]obsfx2.InvalidationListener{s.listener, listener}, nil)
}

func (s *singleInvalidationMapExpressionHelper[K, V]) RemoveListener(listener obsfx2.InvalidationListener) mapExpressionHelper[K, V] {
	if s.listener == listener {
		return nil
	}
...
func (s *singleMapListenerExpressionHelper[K, V]) AddListener(listener obsfx2.InvalidationListener) mapExpressionHelper[K, V] {
	return newGenericInvalidationMapExpressionHelper[K, V]([]obsfx2.InvalidationListener{listener}, []MapListener[K, V]{s.listener})
}

func (s *singleMapListenerExpressionHelper[K, V]) RemoveListener(listener obsfx2.InvalidationListener) mapExpressionHelper[K, V] {
	return s
}
