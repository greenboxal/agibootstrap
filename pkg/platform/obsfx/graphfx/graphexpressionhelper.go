...
import (
	obsfx2 "github.com/greenboxal/agibootstrap/pkg/platform/obsfx"
)

type GraphExpressionHelper[K comparable, N Node, E Edge] interface {
	GraphListener[K, N, E]

	AddListener(listener obsfx2.InvalidationListener) GraphExpressionHelper[K, N, E]
	RemoveListener(listener obsfx2.InvalidationListener) GraphExpressionHelper[K, N, E]
...
type genericInvalidationGraphExpressionHelper[K comparable, N Node, E Edge] struct {
	...
	graphListeners        obsfx2.HasListenersBase[GraphListener[K, N, E]]
}

func newGenericInvalidationGraphExpressionHelper[K comparable, N Node, E Edge](invalidationListeners []obsfx2.InvalidationListener, listListeners []GraphListener[K, N, E]) *genericInvalidationGraphExpressionHelper[K, N, E] {
...
func (g *genericInvalidationGraphExpressionHelper[K, N, E]) AddListener(listener obsfx2.InvalidationListener) GraphExpressionHelper[K, N, E] {
	g.invalidationListeners.AddListener(listener)

	return g
}

func (g *genericInvalidationGraphExpressionHelper[K, N, E]) RemoveListener(listener obsfx2.InvalidationListener) GraphExpressionHelper[K, N, E] {
...
func (s *singleInvalidationGraphExpressionHelper[K, N, E]) AddGraphListener(listener GraphListener[K, N, E]) GraphExpressionHelper[K, N, E] {
	return newGenericInvalidationGraphExpressionHelper[K, N, E]([]obsfx2.InvalidationListener{s.listener}, []GraphListener[K, N, E]{listener})
}
...
func (s *singleInvalidationGraphExpressionHelper[K, N, E]) AddListener(listener obsfx2.InvalidationListener) GraphExpressionHelper[K, N, E] {
	if s.listener == listener {
		return s
	}

	return newGenericInvalidationGraphExpressionHelper[K, N, E]([]obsfx2.InvalidationListener{s.listener, listener}, nil)
}

func (s *singleInvalidationGraphExpressionHelper[K, N, E]) RemoveListener(listener obsfx2.InvalidationListener) GraphExpressionHelper[K, N, E] {
	if s.listener == listener {
		return nil
	}
...
func (s *singleGraphListenerExpressionHelper[K, N, E]) AddListener(listener obsfx2.InvalidationListener) GraphExpressionHelper[K, N, E] {
	return newGenericInvalidationGraphExpressionHelper[K, N, E]([]obsfx2.InvalidationListener{listener}, []GraphListener[K, N, E]{s.listener})
}

func (s *singleGraphListenerExpressionHelper[K, N, E]) RemoveListener(listener obsfx2.InvalidationListener) GraphExpressionHelper[K, N, E] {
	return s
}
