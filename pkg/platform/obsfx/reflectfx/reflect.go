...
import (
	...
	obsfx "github.com/greenboxal/agibootstrap/pkg/platform/obsfx"
...
type ReflectedProperty interface {
	...
	Get(receiver any) obsfx.IProperty
}
...
func (r *reflectionBasedProperty) Get(receiver any) obsfx.IProperty {
	...
	return p.Interface().(obsfx.IProperty)
}
...
var propertyType = reflect.TypeOf((*obsfx.IProperty)(nil)).Elem()
var observableType = reflect.TypeOf((*obsfx.Observable)(nil)).Elem()
...
func AsObservable[T any](val reflect.Value) (obsfx.ObservableValue[T], bool) {
	...
	r, ok := val.Interface().(obsfx.ObservableValue[T])
