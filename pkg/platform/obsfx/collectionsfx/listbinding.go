...
func BindListInterface[Dst ListBindingInterface[T], Src ObservableList[V], V, T any](dst Dst, src Src, mapper func(V) T) obsfx.Binding[ObservableList[T]] {
	temp := &MutableSlice[T]{}
...
func BindList[Dst ModifiableObservableList[T], Src ObservableList[V], V, T any](
	...
	src Src,
	mapper func(V) T,
) obsfx.Binding[ObservableList[T]] {
	b := &listBinding[V, T]{
		dst:    dst,
		src:    src,
		mapper: mapper,
...
type listBinding[V, T any] struct {
	obsfx.ObservableValueBase[ObservableList[T]]
...
func (m *listBinding[V, T]) Dependencies() []obsfx.Observable {
...
func BindListFromMap[Dst ModifiableObservableList[T], Src ObservableMap[K, V], K comparable, V, T any](dst Dst, src Src, mapper func(K, V) T) obsfx.Binding[ObservableList[T]] {
...
func (m *listMapBinding[K, V, T]) Dependencies() []obsfx.Observable {
	return []obsfx.Observable{m.src}
}
