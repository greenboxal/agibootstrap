...
type ModifiableObservableList[T any] interface {
	...
	Bind(binding obsfx.Binding[ObservableList[T]])
	Unbind()
}
...
func (o *ObservableListBase[T]) AddListener(listener obsfx.InvalidationListener) {
	if o.helper == nil {
...
func (o *ObservableListBase[T]) RemoveListener(listener obsfx.InvalidationListener) {
	if o.helper != nil {
