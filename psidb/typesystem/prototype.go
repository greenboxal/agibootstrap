...
func (v ValuePrototype) NewBuilder() datamodel.NodeBuilder {
	return newNodeBuilder(New(v.T))
}
func (v ValuePrototype) Type() schema.Type { return v.T.IpldType() }
func (v ValuePrototype) Representation() datamodel.NodePrototype {
	return reprPrototype{typ: v.T}
}
